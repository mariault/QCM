...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'qcm', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\QCM\\BackBundle\\Entity'))), 'QCM\\BackBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('QCMBackBundle' => 'QCM\\BackBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_93fbe1ec6a2bfa36c3e72e9eb3a27481e167cde11744dc0bf3a667173da6d0bd');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('QCM\\BackBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('noreply@example.com' => 'osef'), 'resetting' => array('noreply@example.com' => 'osef'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('QCM\\BackBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('QCM\\BackBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('QCM\\BackBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'QCM\\BackBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\QCM\\BackBundle/Resources/views'), 'QCMBack');
        $instance->addPath(($this->targetDirs[3].'\\src\\QCM\\FrontBundle/Resources/views'), 'QCMFront');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3ef211e5515e200efb27b5f145e7c2cf4886a26a');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'QCMBackBundle' => 'QCM\\BackBundle\\QCMBackBundle',
                'QCMFrontBundle' => 'QCM\\FrontBundle\\QCMFrontBundle',
            ...
            'secret' => '3ef211e5515e200efb27b5f145e7c2cf4886a26a',
            'locale' => 'en',
            ...
            'kernel.secret' => '3ef211e5515e200efb27b5f145e7c2cf4886a26a',
            ...
            'fos_user.model.user.class' => 'QCM\\BackBundle\\Entity\\Utilisateur',
